...
int main()
{
  ...
  20:	38a080e7          	jalr	906(ra) # 3a6 <pipe>
    forkN = fork();//执行两次，子进程返回0，父进程返回子进程processID
  24:	00000097          	auipc	ra,0x0
  28:	36a080e7          	jalr	874(ra) # 38e <fork>
  2c:	84aa                	mv	s1,a0
    printf("forkN:%d\n",forkN);
  2e:	85aa                	mv	a1,a0
  30:	00001517          	auipc	a0,0x1
  34:	89050513          	addi	a0,a0,-1904 # 8c0 <malloc+0xe4>
  38:	00000097          	auipc	ra,0x0
  3c:	6e6080e7          	jalr	1766(ra) # 71e <printf>
    if(forkN == 0)
  40:	eca5                	bnez	s1,b8 <main+0xb8>
    {
        //close(0);
        //dup(p[0]);
        //close(p[0]);
  ...
  4a:	378080e7          	jalr	888(ra) # 3be <close>
        pid1 = getpid();
  4e:	00000097          	auipc	ra,0x0
  52:	3c8080e7          	jalr	968(ra) # 416 <getpid>
  56:	84aa                	mv	s1,a0
        printf("line 22\n");
  58:	00001517          	auipc	a0,0x1
  5c:	87850513          	addi	a0,a0,-1928 # 8d0 <malloc+0xf4>
  60:	00000097          	auipc	ra,0x0
  64:	6be080e7          	jalr	1726(ra) # 71e <printf>
        read(p[0],charbuf,sizeof(charbuf));
  68:	40000613          	li	a2,1024
  6c:	bd840593          	addi	a1,s0,-1064
  70:	fd842503          	lw	a0,-40(s0)
  74:	00000097          	auipc	ra,0x0
  78:	33a080e7          	jalr	826(ra) # 3ae <read>
        printf("pong received:%s\n",charbuf);
  7c:	bd840593          	addi	a1,s0,-1064
  80:	00001517          	auipc	a0,0x1
  84:	86050513          	addi	a0,a0,-1952 # 8e0 <malloc+0x104>
  88:	00000097          	auipc	ra,0x0
  8c:	696080e7          	jalr	1686(ra) # 71e <printf>
        printf("%d:received ping\n",pid1);
  90:	85a6                	mv	a1,s1
  92:	00001517          	auipc	a0,0x1
  96:	86650513          	addi	a0,a0,-1946 # 8f8 <malloc+0x11c>
  9a:	00000097          	auipc	ra,0x0
  9e:	684080e7          	jalr	1668(ra) # 71e <printf>
        close(p[0]);
  a2:	fd842503          	lw	a0,-40(s0)
  a6:	00000097          	auipc	ra,0x0
  aa:	318080e7          	jalr	792(ra) # 3be <close>
  ...
  b4:	2e6080e7          	jalr	742(ra) # 396 <exit>
        close(p[0]);
  b8:	fd842503          	lw	a0,-40(s0)
  bc:	00000097          	auipc	ra,0x0
  c0:	302080e7          	jalr	770(ra) # 3be <close>
        pid2= getpid();
  c4:	00000097          	auipc	ra,0x0
  c8:	352080e7          	jalr	850(ra) # 416 <getpid>
  cc:	85aa                	mv	a1,a0
        printf("%d:received pong\n",pid2);
  ce:	00001517          	auipc	a0,0x1
  d2:	84250513          	addi	a0,a0,-1982 # 910 <malloc+0x134>
  d6:	00000097          	auipc	ra,0x0
  da:	648080e7          	jalr	1608(ra) # 71e <printf>
        write(p[1],ptr,strlen(ptr));
  de:	fdc42483          	lw	s1,-36(s0)
  e2:	00001517          	auipc	a0,0x1
  e6:	84650513          	addi	a0,a0,-1978 # 928 <malloc+0x14c>
  ea:	00000097          	auipc	ra,0x0
  ee:	07e080e7          	jalr	126(ra) # 168 <strlen>
  f2:	0005061b          	sext.w	a2,a0
  f6:	00001597          	auipc	a1,0x1
  fa:	83258593          	addi	a1,a1,-1998 # 928 <malloc+0x14c>
  fe:	8526                	mv	a0,s1
 100:	00000097          	auipc	ra,0x0
 104:	2b6080e7          	jalr	694(ra) # 3b6 <write>
        wait(0);
 108:	4501                	li	a0,0
 10a:	00000097          	auipc	ra,0x0
 10e:	294080e7          	jalr	660(ra) # 39e <wait>
        close(p[1]);
 112:	fdc42503          	lw	a0,-36(s0)
 116:	00000097          	auipc	ra,0x0
 11a:	2a8080e7          	jalr	680(ra) # 3be <close>
 11e:	bf41                	j	ae <main+0xae>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48e:	4ae50513          	addi	a0,a0,1198 # 938 <digits>
 492:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 69a:	29a90913          	addi	s2,s2,666 # 930 <malloc+0x154>
        while(*s != 0){
...
free(void *ap)
{
 ...
 762:	1f27b783          	ld	a5,498(a5) # 950 <freep>
 ...
 790:	00e6ea63          	bltu	a3,a4,7a4 <free+0x50>
{
 ...
 7d2:	18f73123          	sd	a5,386(a4) # 950 <freep>
}
 7d6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 804:	15053503          	ld	a0,336(a0) # 950 <freep>
 ...
 82c:	12890913          	addi	s2,s2,296 # 950 <freep>
  if(p == (char*)-1)
 830:	5afd                	li	s5,-1
 832:	a88d                	j	8a4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 834:	00000797          	auipc	a5,0x0
 838:	12478793          	addi	a5,a5,292 # 958 <base>
 83c:	00000717          	auipc	a4,0x0
 840:	10f73a23          	sd	a5,276(a4) # 950 <freep>
 844:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 866:	0ea73723          	sd	a0,238(a4) # 950 <freep>
      return (void*)(p + 1);
